...
import { Button, Surface, TextInput, List, useTheme, Text } from "react-native-paper";
    ...
    <SafeAreaProvider>
      <BaseLayout>
        <View style={styles.container}>
          <Text variant="bodySmall">Add an item</Text>
          {photo ? (
            <Image style={styles.icon} source={{ uri: photo.uri }}></Image>
          ) : (
            <Image
